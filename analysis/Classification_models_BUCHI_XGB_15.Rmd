...
```{r}
 ...
 save(testing,modelFit1, 
      file = here::here("output", "XGB_BUCHI_Model_Cook15.RData"))
 }
```
...
save(testing,modelFit1, 
     file = here::here("output", "XGB_BUCHI_Model_Cook20.RData"))
}
```
...
trait <- Cooking_traits[3]
  ...
  modelFit1[[3]] <- train(Cook25 ~ ., data = training2, 
                     ...
                     preProcess = c("center","scale"))
save(testing,modelFit1, 
     file = here::here("output", "XGB_BUCHI_Model_Cook25.RData"))
}
```
...
trait <- Cooking_traits[4]
  ...
  modelFit1[[4]] <- train(Cook30 ~ ., data = training2, 
                     ...
                     preProcess = c("center","scale"))
save(testing,modelFit1, 
     file = here::here("output", "XGB_BUCHI_Model_Cook30.RData"))
}
```
...
trait <- Cooking_traits[5]
  ...
  modelFit1[[5]] <- train(Cook40 ~ ., data = training2, 
                     ...
                     preProcess = c("center","scale"))
save(testing,modelFit1, 
     file = here::here("output", "XGB_BUCHI_Model_Cook40.RData"))
}
```
