...
### plot Cook15
```{r}
#PT_Cook15_ASD <- resCV_2

ROC <- ggplot(PT_Cook15_ASD, aes(x=PT, y=ROC, fill=PT)) + 
  geom_boxplot()   + theme_bw() + ylim(0.82, 1) + ggtitle("ASD - Cook15")
 
Sens <- ggplot(PT_Cook15_ASD, aes(x=PT, y=Sens, fill=PT)) + 
  geom_boxplot() + theme_bw() + ylim(0.7, 1) + ggtitle("ASD - Cook15")

Spec <- ggplot(PT_Cook15_ASD, aes(x=PT, y=Spec, fill=PT)) + 
  geom_boxplot()  + theme_bw() + ylim(0.7, 1) + ggtitle("ASD - Cook15") 
...
### Save data
```{r}
save(PT_Cook15_ASD,PT_Cook20,PT_Cook25,PT_Cook30,
